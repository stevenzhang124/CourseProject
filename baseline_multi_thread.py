...
if __name__ == '__main__':
    ...
    source_data, _, target_test_data = load_data(
        source_name, target_name, data_dir='dataset/')
    unlabeled_weak_data, unlabeled_strong_data = load_unlabeled_data(
        target_name, data_dir='dataset/')
    ...
    source_loader = DataLoader(
        source_data, batch_size=args.local_bs, shuffle=True, num_workers=4)
    target_test_loader = DataLoader(
        target_test_data, batch_size=args.bs, shuffle=True, num_workers=4)
