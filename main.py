...
if __name__ == '__main__':
    ...
    source_data, target_train_data, target_test_data = load_data(source_name, target_name, data_dir='dataset/')
    ...
    plt.savefig('./save/fed_{}_{}_{}_C{}_iid{}.png'.format(source_name, target_name, args.epochs, args.frac, args.iid))
