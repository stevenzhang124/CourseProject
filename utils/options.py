...
def args_parser():
    ...
    parser.add_argument('--n_class', type=int, default=31, help="Number of classes")
    parser.add_argument('--lam', type=float, default=10, help="lambda of transfer loss")
    parser.add_argument('--l2_decay', type=float, default=0, help="l2_deacy")

    #other arguments
    parser.add_argument('--iid', action='store_true', help='whether iid or not')
